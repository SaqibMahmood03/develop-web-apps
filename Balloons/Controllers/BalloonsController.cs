...
namespace Balloons.Controllers
{
    ...
    {
        private readonly BalloonsContext _context;

        public BalloonsController(BalloonsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Balloon balloon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Balloon balloon)
        {
            if (id != balloon.Id)
            {
                return NotFound();
